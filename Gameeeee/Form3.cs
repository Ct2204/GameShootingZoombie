    ...
    public partial class Form3 : Form
    {
        ...
        private void KeyIsDown(object sender, KeyEventArgs e)
        {
...

            {
                ...
                if (ammo < 25) // if ammo is less than 1
                {
        ...
        private void DropHeart()
        {
            ...
            heart.Left = randNum.Next(10, 850); // set the location to a random left
            heart.Top = randNum.Next(50, 600); // set the location to a random top
